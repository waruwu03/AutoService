  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border overflow-x-hidden">
      <SidebarHeader className="p-4">
        <Link href="/pimpinan" className="flex items-center gap-3">
          ...
          <div className="flex flex-col group-data-[collapsible=icon]:hidden">
            ...
            <span className="text-[10px] font-bold tracking-[0.2em] text-white/70 uppercase leading-none mt-0.5">Pimpinan</span>
          </div>
        </Link>
      </SidebarHeader>
